...
local DRONE_ANIMS =
{
	...
	shootcover2 = "shoot",
	shootcover3 = "shoot",
	shootcover_pre = "shoot_pre",
	shootcover_pst = "shoot_pst",
	overwatch_pre = "shoot_pre",
	overwatch = "shoot_pre",
...
local animdefs =
{
	...
	kanim_stealth_male =
	{
		wireframe =
		{
			"data/anims/characters/agents/stealth_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/agents/stealth.abld",
		...
		grp_build = 
		{
			"data/anims/characters/agents/grp_stealth.abld",
		},
	...
	kanim_hacker_male =
	{
		...
		build = 
		{ 
			"data/anims/characters/agents/engineer.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",		 
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	
		},
	...
	kanim_sharpshooter_male =
	{
		wireframe =
		{
			"data/anims/characters/agents/sharpshooter_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/agents/sharpshooter.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",	
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	 	 
		},
		grp_build = 
		{
			"data/anims/characters/agents/grp_sharpshooter.abld",
		},
		anims = commonanims.male.default_anims_unarmed,
		anims_1h = commonanims.male.default_anims_1h,
		anims_2h = commonanims.male.default_anims_2h,
	...
	kanim_female_engineer_2 =
	{
		wireframe =
		{
			"data/anims/characters/agents/support_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/agents/support.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",		 
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	
		},
		grp_build = 
		{
			"data/anims/characters/agents/grp_support.abld",
		},
	...
	kanim_female_stealth_2 =
	{
		wireframe =
		{
			"data/anims/characters/agents/ghost_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/agents/ghost.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",		 
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	
		},
		grp_build = 
		{
			"data/anims/characters/agents/grp_ghost.abld",
		},
        anims = commonanims.female.default_anims_unarmed,
		anims_1h = commonanims.female.default_anims_1h,
		anims_2h = commonanims.female.default_anims_2h,
	...
	kanim_female_sharpshooter_2 =
	{
		wireframe =
		{
			"data/anims/characters/agents/hunter_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/agents/hunter.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",		 
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	
		},
		grp_build = 
		{
			"data/anims/characters/agents/grp_hunter.abld",
		},
        anims = commonanims.female.default_anims_unarmed,
		anims_1h = commonanims.female.default_anims_1h,
		anims_2h = commonanims.female.default_anims_2h,
...
-----------------------------------------------------------------------
	...
	kanim_guard_male =
	{
		wireframe =
		{
			"data/anims/characters/corp_neutral/guard_overlay.abld",
		},
		build = 
		{ 
			"data/anims/characters/corp_neutral/guard.abld",
			"data/anims/characters/anims_male/shared_hits_01.abld",	
			"data/anims/characters/anims_male/shared_attacks_a_01.abld",	 	 
		},
		grp_build = 
	...
	kanim_guard_male_sankaku =
	{
		wireframe =
		{
			"data/anims/characters/corp_SK/sankaku_med_overlay.abld",
		},
		build = 
		{ 
	...
	kanim_guard_tier2_male_sankaku =
	{
		wireframe =
		{
			"data/anims/characters/corp_SK/sankaku_med_2_overlay.abld",
		},
		build = 
		{ 
...
-----------------------------------------------------------------------------------------
	...
	kanim_drone_tier2_SA =
	{
		build = 
		{ 
			"data/anims/characters/corp_SK/sankaku_droid_heavy.abld",	 
		},
		anims =
		{		
			"data/anims/characters/corp_SK/sankaku_droid_heavy.adef",
		},
		anims_1h =
		{
			"data/anims/characters/corp_SK/sankaku_droid_heavy.adef",
	...
	kanim_drone_akuma_SA =
	{
		build = 
		{ 
			"data/anims/characters/corp_SK/sankaku_droid_tank_build.abld",	 
		},
		anims =
		{		
	...
	kanim_hud_mainframe_hud =
	{
		build = { "data/anims/gui/hud_mainframe_hud.abld" },
		anims = { "data/anims/gui/hud_mainframe_hud.adef" },
		--symbol = "APMeter",
		anim = "defualt",
		scale = 0.1,
		layer = Layer.Unit,
...
-------------------------------------------------------------------------------------------------
	...
	{
		build = { "data/anims/FTM_office/office_object_1x1sidetable.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_office/office_object_1x1sidetable.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_office/office_object_2x1shortbookshelf.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_office/office_object_2x1shortbookshelf.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_office/office_object_1x1printersidetable.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_office/office_object_1x1printersidetable.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
...
--SECURITY ITEMS
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1gear1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1gear1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1gear2.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1gear2.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1cabinet.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1cabinet.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1filingcabinet.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1filingcabinet.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1interrogationtable1.abld", "data/anims/general/mf_coverpieces_2x2.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1interrogationtable1.adef", "data/anims/general/mf_coverpieces_2x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x2,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1kitchen.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1kitchen.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1locker.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1locker.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1shelf.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1shelf.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_tall_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_1x1watercooler.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_security/security_object_1x1watercooler.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_2x1bench.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_security/security_object_2x1bench.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_2x1console1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_security/security_object_2x1console1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_security/security_object_2x1console2.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_security/security_object_2x1console2.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
...
-- SECURITY END
	...
	kanim_laser =
	{
		build = { "data/anims/mainframe/office_object_1x1lasers.abld"},
		anims = { "data/anims/mainframe/office_object_1x1lasers.adef"},
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
		filterSymbols = {{symbol="internal",filter="default"},{symbol="lines_new",filter="default"}},
	},

	kanim_infrared_beam =
	{
		build = { "data/anims/mainframe/mainframe_object_1x1lasers_light.abld"},
		anims = { "data/anims/mainframe/mainframe_object_1x1lasers_light.adef"},
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
		filterSymbols = {{symbol="internal",filter="default"},{symbol="lines",filter="default"}},
	},

	kanim_infrared_wall =
	{
		build = { "data/anims/mainframe/mainframe_object_1x1lasers_wall.abld" },
		anims = { "data/anims/mainframe/mainframe_object_1x1lasers_wall.adef"},
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
		filterSymbols = {{symbol="wallbeam",filter="default"},{symbol="lines_new",filter="default"}},
	},
	...
	decor_lab_bulletin1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_bulletin1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_bulletin1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_lab_cabinet1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_cabinet1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_cabinet1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_lab_paintings2 =
	{
		build = { "data/anims/FTM_lab/decor_lab_paintings2.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_paintings2.adef" },
		anim = "idle",
		scale = 0.25,
	...
	decor_lab_picture1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_picture1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_picture1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	},
	decor_lab_postgizmo1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_postgizmo1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_postgizmo1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},
	decor_lab_sink1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_sink1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_sink1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_lab_trashcan1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_trashcan1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_trashcan1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},
	decor_lab_wallgizmo1 =
	{
		build = { "data/anims/FTM_lab/decor_lab_wallgizmo1.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_wallgizmo1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_office_paintings1 =
	{
		build = { "data/anims/FTM_office/decor_office_paintings1.abld" },
		anims = { "data/anims/FTM_office/decor_office_paintings1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	},
	decor_office_paintings2 =
	{
		build = { "data/anims/FTM_office/decor_office_paintings2.abld" },
		anims = { "data/anims/FTM_office/decor_office_paintings2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	...
	decor_office_vent1 =
	{
		build = { "data/anims/FTM_office/decor_office_vent1.abld" },
		anims = { "data/anims/FTM_office/decor_office_vent1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_office_walllight1 =
	{
		build = { "data/anims/FTM_office/decor_office_walllight1.abld" },
		anims = { "data/anims/FTM_office/decor_office_walllight1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	...
	decor_hall_ottoman1 =
	{
		build = { "data/anims/FTM_hall/decor_hall_ottoman1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_ottoman1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	
	decor_hall_painting1 =
	{
		build = { "data/anims/FTM_hall/decor_hall_painting1.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_painting1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	},	
	decor_hall_painting2 =
	{
		build = { "data/anims/FTM_hall/decor_hall_painting2.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_painting2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },   
	},		
	decor_hall_painting3 =
	{
		build = { "data/anims/FTM_hall/decor_hall_painting3.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_painting3.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	},		
	decor_hall_painting4 =
	{
		build = { "data/anims/FTM_hall/decor_hall_painting4.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_painting4.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	},		
	decor_hall_painting5 =
	{
		build = { "data/anims/FTM_hall/decor_hall_painting5.abld" },
		anims = { "data/anims/FTM_hall/decor_hall_painting5.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall_Painting,
		skins = { "painting" },
	...
	decor_security_bulletinboard =
	{
		build = { "data/anims/FTM_office/decor_office_bulletinboard1.abld" },
		anims = { "data/anims/FTM_office/decor_office_bulletinboard1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},
	decor_security_mapscreen =
	{
		build = { "data/anims/FTM_office/decor_office_mapscreen1.abld" },
		anims = { "data/anims/FTM_office/decor_office_mapscreen1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall2,
	},	
	decor_security_securitypanel =
	{
		build = { "data/anims/FTM_office/decor_office_securitypanel1.abld" },
		anims = { "data/anims/FTM_office/decor_office_securitypanel1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},	
	decor_security_wallbox1 =
	{                         
		build = { "data/anims/FTM_security/decor_office_wallbox1.abld" },
		anims = { "data/anims/FTM_security/decor_office_walbox1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},		
	decor_security_wallbox2 =
	{
		build = { "data/anims/FTM_security/decor_office_wallbox2.abld" },
		anims = { "data/anims/FTM_security/decor_office_walbox2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall,
	},		
	decor_security_wallscreen =
	{
		build = { "data/anims/FTM_office/decor_office_wallscreen1.abld" },
		anims = { "data/anims/FTM_office/decor_office_wallscreen1.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.Wall2,
	},		
	...
	decor_office_planter_2_2x1 =
	{
		build = "data/anims/FTM_office/office_object_2x1planter_2.abld",
		anims = { "data/anims/FTM_office/office_object_2x1planter_2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	decor_hall_bookshelf_2x1 =
	{
		build = "data/anims/FTM_hall/hall_object_2x1bookshelf.abld",
		anims = { "data/anims/FTM_hall/hall_object_2x1bookshelf.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	decor_lab_coats =
	{
		build = { "data/anims/FTM_lab/decor_lab_coats.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_coats.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	
	...
	decor_lab_poster =
	{
		build = { "data/anims/FTM_lab/decor_lab_poster.abld" },
		anims = { "data/anims/FTM_lab/decor_lab_poster.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	

	decor_lab_2x1_blackboard_2=
	{
		build = { "data/anims/FTM_lab/lab_object_2x1blackboard_2.abld" },
		anims = { "data/anims/FTM_lab/lab_object_2x1blackboard_2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	decor_bathroom_trash_towel =
	{
		build = { "data/anims/FTM_lab/decor_bathroom_papertoewl_trash.abld" },
		anims = { "data/anims/FTM_lab/decor_bathroom_papertoewl_trash.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	
	...
	decor_bathroom_sink =
	{
		build = { "data/anims/FTM_lab/decor_bathroom_sink.abld" },
		anims = { "data/anims/FTM_lab/decor_bathroom_sink.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	

	decor_bathroom_urinal =
	{
		build = { "data/anims/FTM_lab/decor_bathroom_urinal.abld" },
		anims = { "data/anims/FTM_lab/decor_bathroom_urinal.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_1x1_med_med,
	},	
...
-- FTM OFFICE --------------------------------------------------------------------------------------------
	...
	ftm_office_2x1_desk1_items1=
	{
		build = { "data/anims/FTM_office/ftm_office_object_2x1desk1_items1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/FTM_office/ftm_office_object_2x1desk1_items1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_office/ftm_office_object_2x1planter_2.abld" },
		anims = { "data/anims/FTM_office/ftm_office_object_2x1planter_2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_office/ftm_office_object_2x1benchtable1.abld" },
		anims = { "data/anims/FTM_office/ftm_office_object_2x1benchtable1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_office/ftm_office_object_2x1horizontalfilecabinet1.abld" },
		anims = { "data/anims/FTM_office/ftm_office_object_2x1horizontalfilecabinet1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
...
-- FTM LAB -----------------------------------------------------------------------------------------------
	...
	ftm_lab_postgizmo1=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_postgizmo1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_postgizmo1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_trashcan1=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_trashcan1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_trashcan1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_closet1=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_closet1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_closet1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_gear1=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_gear1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_gear1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_gear2=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_gear2.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_gear2.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_gear3=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_gear3.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_gear3.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_stool1=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_stool1.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_stool1.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_stool2=
	{
		build = { "data/anims/FTM_hall/ftm_decor_lab_stool2.abld", "data/anims/general/mf_coverpieces_1x1.abld" },
		anims = { "data/anims/FTM_hall/ftm_decor_lab_stool2.adef", "data/anims/general/mf_coverpieces_1x1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_1x1_med_med,
	...
	ftm_lab_blackboard2 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1blackboard_2.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1blackboard_2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	ftm_lab_console1 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1console1.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1console1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	ftm_lab_console2 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1console2.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1console2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	ftm_lab_console3 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1console3.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1console3.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1horizontalfilecabinet1.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1horizontalfilecabinet1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1horizontalfilecabinet1_items1.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1horizontalfilecabinet1_items1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	ftm_lab_steeltable1 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1steeltable11.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1steeltable11.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	ftm_lab_steeltable2 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x1steeltable12.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x1steeltable12.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x1_med_med,
	...
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x2table1_items1.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x2table1_items1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x2_med_med,
		filterSymbols = {{symbol="icon",filter="default"},{symbol="light",filter="default"}},
	},

	ftm_lab_table1_items2 =
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x2table1_items2.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x2table1_items2.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x2_med_med,
	...
	{
		build = { "data/anims/FTM_hall/ftm_lab_object_2x2table3_items1.abld" },
		anims = { "data/anims/FTM_hall/ftm_lab_object_2x2table3_items1.adef" },
		symbol = "character",
		scale = 0.25,
		layer = Layer.Object,
		boundType = BoundType.bound_2x2_med_med,
...
-- KO LAB ---------------------------------------------------------------------------------------------
	...
	{
		build = { "data/anims/Plastek_psilab/plastek_psilab_object_2x1psitank1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/Plastek_psilab/plastek_psilab_object_2x1psitank1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_2x2,
	},		
	...
	{
		build = { "data/anims/Plastek_psilab/plastek_psilab_object_2x1psitankgear1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/Plastek_psilab/plastek_psilab_object_2x1psitankgear1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_2x2,
	},		
	...
	{
		build = { "data/anims/Plastek_Lab/plastek_lab_object_2x2floorhatch2.abld"},
		anims = { "data/anims/Plastek_Lab/plastek_lab_object_2x2floorhatch2.adef"},
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_2x2,
	},		
	...
	{
		build = { "data/anims/Unique_nanofab/nanofab_2x1_displaycase1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/Unique_nanofab/nanofab_2x1_displaycase1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		anim = "idle",
		scale = 0.25,
...
-- KO floor crap  ---------------------------------------------------------------------------------------------
	...
	{
		build = { "data/anims/Unique_ceooffice/ceooffice_3x1_ceodesk1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/Unique_ceooffice/ceooffice_3x1_ceodesk1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_2x1_med_med, 
	},
	...
	{
		build = { "data/anims/Unique_ceooffice/ceooffice_3x2_boardroomtable1.abld", "data/anims/general/mf_coverpieces_1x2.abld" },
		anims = { "data/anims/Unique_ceooffice/ceooffice_3x2_boardroomtable1.adef", "data/anims/general/mf_coverpieces_1x2.adef" },
		anim = "idle",
		scale = 0.25,
		boundType = BoundType.bound_2x1_med_med, 
	},
