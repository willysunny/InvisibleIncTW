...
-----------------------------------------
-- hotkeys
cdefs.KEY_BIND_PEEK = 				"P"
cdefs.KEY_BIND_HIDE = 				"H"
cdefs.KEY_BIND_WIRELESS = 			"I"
cdefs.KEY_BIND_EXIT = 				"X"
cdefs.KEY_BIND_OVERWATCH =			"O"
cdefs.KEY_BIND_OVERWATCH_MELEE =	"M"
cdefs.KEY_BIND_RUN =				"R"

--[[  THESE ARE NOT IMPLAMENTED AS THESE cdefs yet.
cdefs.KEY_BIND_CAM_UP =				"W"
cdefs.KEY_BIND_CAM_DOWN =			"S"
cdefs.KEY_BIND_CAM_LEFT =			"A"
cdefs.KEY_BIND_CAM_RIGHT =			"D"
cdefs.KEY_BIND_CAM_ROTATE_LEFT =	"Q"
cdefs.KEY_BIND_CAM_ROTATE_RIGHT =	"E"
]]
...
cdefs.LOG_LOC = "LOG_LOC" -- Hm. Shouldn't conflict with simdefs.LOG_*.

-----------------------------------------
-- Sound constants

cdefs.SOUND_UI_CANCEL = "SpySociety/HUD/cancel"
cdefs.SOUND_UI_CONFIRM = "SpySociety/HUD/confirm"
cdefs.SOUND_UI_NEWTURN = "SpySociety/HUD/newturn"
...
cdefs.ZONES_PRIORITY = 10000		-- in front of pretty much everything, but in front of the board (floors)
...
cdefs.WALL_SECURITY_LOCKED = UVTex( 2, 0 )
cdefs.WALL_SECURITY_LOCKED_ALT = UVTex( 3, 0 )
cdefs.WALL_SECURITY_UNLOCKED = UVTex( 2, 0 )
cdefs.WALL_SECURITY_UNLOCKED_ALT = UVTex( 3, 0 )
...
cdefs.DANGERTILES_PARAMS =
{
	files = { "data/images/dangertiles0.png", "data/images/dangertiles1.png", "data/images/dangertiles2.png", "data/images/dangertiles1.png", },
	4,			--width in tiles
	4,			--height in tiles
	48/192,		--cellWidth
	48/192,		--cellHeight
...
cdefs.ZONE_TECH_PSI = { name = "tech_psi", pattern = "lab", wallUV = UVTex( 6, 5 ), postUV = UVPostTex( 0, 4 ) }
...
cdefs.MAINFRAME_DANGER_CELL = 4 -- Tile index into DANGERTILE_FILES for 'danger'
cdefs.PSI_DANGER_CELL = 1 -- Tile index into DANGERTILE_FILES for 'psi danger' cell
cdefs.TUTORIAL_DANGER_CELL = 2 -- Tile index into DANGERTILE_FILES for 'psi danger' cell

cdefs.FOW_CELL_OFFSET = 294 -- Tile offset into the FOW set
cdefs.DANGER_CELL_OFFSET = 147 -- Tile offset into the Danger set
...
cdefs.TILE_OFFICE = 7 -- Index into MAPTILES for a reasonable default tile.
...
cdefs.COLOR_WATCHED = util.color( 50/255, 0, 0 )
cdefs.COLOR_WATCHED_BOLD = util.color( 255/255, 1/255, 1/255 )
cdefs.COLOR_NOTICED = util.color( 50/255, 50/255, 0 )
...
-------------------------------------------------------------
-- In-game secret notes.

cdefs.NOTES = {}

local function readNotes( filename )
	local function addNote( key, lines )
		if key and #lines > 0 then
			if cdefs.NOTES[key] == nil then
				cdefs.NOTES[key] = {}
			end
			table.insert( cdefs.NOTES[key], table.concat(lines, "\n" ))
			while #lines > 0 do
				table.remove(lines)
			end
		end
	...
	if fl then
		...
		log:write( "WARNING: Failed to read notes.\n%s", debug.traceback() )
	end
end


cdefs.THOUGHTVIS_TOOLTIPS = {
	investigating = "Investigating curious event",
	engaged = "Intruder spotted",
	combat = "Engaging intruder",
	hunting = "Hunting for intruder",
}

cdefs.INTEREST_TOOLTIPS = {
	investigating = {line="Security is curious about this location",icon="gui/icons/thought_icons/status_investigating.png"},	
	hunting = {line="Security is closing on this location",icon="gui/icons/thought_icons/status_hunt.png"}	
}

readNotes( "data/misc/notes.txt" )
